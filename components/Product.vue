<template>
  ...
  <div class="item-card item-card-1" style="margin: 0 auto">
    ...
    <div class="container-hover">
      <!-- <h4 class="item-title font-weight-normal mb-0">
        <nuxt-link :to="{ path: `/product/${item.slug}` }" class="text-truncate">{{
          item.name
        }}</nuxt-link>
      </h4> -->
      ...
      <div v-if="!isMobile">
        <div class="block-prices">
          <span>
            ...
            <!-- <div v-if="!item.promotion_price && item.old_product_price && item.old_product_price != item.price" class="special">
              <span
                class="product-old-price"
          ...
          <!-- <div class="badge-promotion" v-if="!item.promotion_price && item.old_product_price && item.old_product_price != item.price">
      ...
      <div class="group-buy-price-mobile" v-if="isMobile">
        <div class="row">
          <div class="col-8">
            <div class="d-flex flex-row">
              ...
              <!-- <del
                class="float-right special-ismobile"
                v-if="!item.promotion_price && item.old_product_price && item.old_product_price != item.price"
          ...
          <div class="col-4">
            <div class="text-right" v-if="item.promotion_price">
              <span class="percent-ismobile hide-360"
                >-{{ item.special_percentage_formatted }}</span
              >
            </div>
            <!-- <div class="text-right" v-if="!item.promotion_price && item.old_product_price && item.old_product_price != item.price">
              <span class="percent-ismobile hide-360"
        ...
        <div>
          ...
          <!-- <div class="float-right" v-if="!item.promotion_price && item.old_product_price && item.old_product_price != item.price">
            <span class="percent-ismobile show-360"
              >-{{ item.percentage_price_old }}</span
            >
          </div> -->
        ...
        >
          <a
            ...
            v-if="item.price && item.price > 0 && item.qty && item.qty > 0"
          >
      ...
      <div
        class="btn-fnc"
        id="btn-fnc"
        v-if="!isMobile && item.price && item.price > 0 && item.qty && item.qty > 0"
      >
        <div class="d-flex">
          <a
