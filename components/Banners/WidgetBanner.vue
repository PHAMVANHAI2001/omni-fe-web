  ...
  <section class="position-relative section-nummer">
    <div class="container">
      <div class="row ml-0 mr-0">
        <div
          data-aos="fade-up"
          class=" ml-0 mr-0 pl-0 pr-0 mb-1 "
          v-if="fist"
          v-bind:class="[
            banners.length == 0
              ? 'col-12'
        ...
        >
          <div
            class="pr-xl-0 pl-xl-0 pl-sm-0 pr-sm-0"
          ...
          >
            <div
              class="d-flex ml-1 mr-0 pl-sm-0 pr-sm-0 mb-1 align-items-center"
            >
              <div>
                <a
...
export default {
  ...
  methods: {
    checkLengthImg() {
      this.$store
        .dispatch("app/fetchData", "/v1/client/banners/WIDGET-BANNER")
        .then(resp => {
          if (resp.data) {
